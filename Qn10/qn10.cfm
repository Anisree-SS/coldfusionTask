...
<head>
    ...
    <link rel="stylesheet" href="./style/styleQn10.css">
    <title>Document</title>
</head>
<body>
    <div>
        <form action="qn10.cfm" method="post">
    ...
    <div>
        <cfif StructKeyExists(form,"key")>
            <cfinvoke component = "component/qn10" method ="printStruct" returnVariable = "keyValue">
